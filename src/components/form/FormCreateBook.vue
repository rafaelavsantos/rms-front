    ...
    <form class="form-wrapper" @submit.prevent.stop="updateUser" @reset="goToBook">
        <div class="form-container">
            ...
            <div class="form-column">
                ...
                <div class="form-field" v-if="!readingMomentCreate">
        ...
        <div class="container-switch">
            <input class="switch switch--shadow" type="checkbox" name="switch-shadow" id="switch-shadow" v-model="readingMomentCreate"/>
...
const readingMomentCreate = ref(false);
